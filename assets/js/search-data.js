...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/";
          ...
          title: "projects",
          description: "Hardware design projects and embedded systems solutions.",
          section: "Navigation",
          handler: () => {
          ...
          title: "publications",
          description: "Publications and research contributions in hardware design and embedded systems.",
          section: "Navigation",
          handler: () => {
          ...
          title: "cv",
          description: "Complete curriculum vitae including education, experience, skills, and achievements.",
          section: "Navigation",
          handler: () => {
        ...
        handler: () => {
          ...
          section: "Books",handler: () => {
            ...
            },},{id: "news-runner-up-in-nmsu-data-mining-contest-with-97-accuracy-in-customer-query-intent-classification-challenge",
          title: 'Runner-up in NMSU Data Mining Contest with 97% accuracy in customer query intent...',
          description: "",
          section: "News",},{id: "news-completed-senior-hardware-design-role-at-tatweer-middle-east-amp-amp-africa-delivering-production-ready-automotive-telematics-systems",
          title: 'Completed Senior Hardware Design role at Tatweer Middle East &amp;amp;amp; Africa, delivering production-ready...',
          description: "",
        ...
        section: 'Socials',
        handler: () => {
          window.open("https://scholar.google.com/citations?user=OIW1wDYAAAAJ", "_blank");
        },
      },{
